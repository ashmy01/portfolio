        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
              <p>
                ...
                <span className="text-foreground font-medium"> aesthetics and functionality</span>, 
          ...
          <div className="grid grid-cols-2 gap-6">
            {skills.map((skill, index) => (
              <div 
                key={skill.name}
                className="p-6 bg-card rounded-xl border border-border hover:border-accent/50 transition-all duration-300 hover:shadow-lg group"
                style={{
